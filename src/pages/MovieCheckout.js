...
const MovieCheckout = () => {
    return (
      <>
        <div>
          <section
            className="details-banner event-details-banner hero-area bg_img seat-plan-banner style-two"
            data-background="assets/images/banner/banner10.jpg"
          >
            <div className="container">
              <div className="details-banner-wrapper">
                <div className="details-banner-content style-two">
                  <h3 className="title">
                    <span className="d-block">football league</span>
                    <span className="d-block">tournament</span>
                  </h3>
                  <div className="tags">
              ...
              <div className="row">
                <div className="col-lg-8">
                  <div className="checkout-widget d-flex flex-wrap align-items-center justify-cotent-between">
                    ...
                    <Link to="/sign-in" className="sign-in-area">
                  ...
                  <div className="checkout-widget checkout-contact">
                    ...
                    <div className="ticket--area row justify-content-center">
                      <div className="col-sm-6 col-md-4">
                        <div className="sports-ticket style-two">
                    ...
                    <form className="payment-card-form">
                      ...
                      <div className="form-group check-group">
                        ...
                        <label htmlFor="card5">
                          ...
                          <span className="info">
                            Save this card information to my Boleto account and
