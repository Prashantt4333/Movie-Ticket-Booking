                  ...
                  <div className="event-about-content">
                    <div className="section-header-3 left-style m-0">
                      ...
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor ut labore et dolore magna aliqua.
                        Quis ipsum suspendisse ultrices gravida.Lorem ipsum
                ...
                <div className="col-lg-4">
                  <div className="section-header-3 left-style mb-lg-0">
                    ...
                    <p>
                      ...
                      services seamlessly empower fully researched growth
                      strategies
                    </p>
                  </div>
                </div>
            ...
            <div className="container">
              <div className="section-header-3">
                ...
                <p>
                  ...
                  harassment free experience for everyone, regardless of level
                ...
                <div className="speaker-slider owl-carousel owl-theme">
                  <div className="speaker-item">
                    ...
                    <div className="speaker-content">
                      <h5 className="title">
                        <a href="/event-speaker">Gerard Bryan</a>
                      </h5>
                  ...
                  <div className="speaker-item">
                    ...
                    <div className="speaker-content">
                      <h5 className="title">
                        <a href="/event-speaker">Raihan Rafuj</a>
                      </h5>
                      <span>CO-FOUNDER, CEO</span>
                    </div>
                  </div>
                  <div className="speaker-item">
                    ...
                    <div className="speaker-content">
                      <h5 className="title">
                        <a href="/event-speaker">Bela Bose</a>
                      </h5>
                      <span>CO-FOUNDER, CEO</span>
                    </div>
                  </div>
                  <div className="speaker-item">
                    ...
                    <div className="speaker-content">
                      <h5 className="title">
                        <a href="/event-speaker">Grass Hopper</a>
                      </h5>
                      <span>CO-FOUNDER, CEO</span>
                    </div>
                  </div>
              ...
              <div className="row justify-content-center gallery-wrapper mb-30-none">
                <div className="col-lg-3 col-sm-6">
                  ...
                  <div className="gallery-item two">
                    <div className="gallery-thumb">
                      <a
                        href="assets/images/gallery/gallery07.jpg"
                        className="img-pop"
                      >
                        <i className="flaticon-loupe" />
                      </a>
                ...
                <div className="col-sm-6 col-lg-3 order-lg-1">
                  ...
                  <div className="gallery-item two">
                    <div className="gallery-thumb">
                      <a
                        href="assets/images/gallery/gallery13.jpg"
                        className="img-pop"
                      >
                        <i className="flaticon-loupe" />
                      </a>
                ...
                <div className="col-lg-6">
                  <div className="gallery-item two">
                    <div className="gallery-thumb">
                      <a
                        href="assets/images/gallery/gallery08.jpg"
                        className="img-pop"
                      >
                        <i className="flaticon-loupe" />
                      </a>
                ...
                <div className="col-lg-6">
                  <div className="tour-content">
                    <div className="section-header-3 left-style">
                      ...
                      <p className="ml-0">
                        Because more peace of mind means more love for the
                        event.
                      </p>
                    </div>
